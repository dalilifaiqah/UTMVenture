...
<body>
        ...
        <div class="row" style="margin: 5px;">
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <!-- ***** Menu Start ***** -->
                    <ul class="nav">
                      <li><a href="{{ route('activity.index') }}" class="active">Dashboard</a></li>
                        <li><a href="{{ route('activity.adminindex') }}" >Venture</a></li>
  ...
  <div class="page-heading">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
            <h4>Approving and list of Activities and Events in UTM</h4>
        ...
        <div class="col-lg-12 " >
          <div class="shadow-2-strong" id="admindashboard">
            <div class="card-body text-center">
                <h4 class="pd-5">User Request to Advertise</h4>
                            ...
                            <tr style="vertical-align:middle">
                                ...
                                <td class="text-center">
                                    <form method="post" action="{{ route('activity.delete',$activity->id) }}">
                                        ...
                                        <!-- <button type="button"   onclick="confirmDelete('{{ $activity->id }}')" class="btn btn-danger btn-sm px-3  mg-3">
                                          <i class="fa-solid fa-delete-left"></i>
                                        </button> -->

                                        <!-- <a class="btn btn-black btn-sm px-3 mg-3" href="{{ url('activities/'.$activity->id.'/edit') }}">
                                        <i class="fa-regular fa-pen-to-square"></i></a> -->
                                        <!--<button type="button" class=" btn-black btn-sm px-3  mg-3">
...
<!-- <script>
   function confirmDelete(activityId) {
      ...
      if (result) {
         // If the user clicks "OK" in the confirmation dialog, redirect to the delete route
         window.location.href = '{{ route('activity.delete', ['activity' => ':activityId']) }}'.replace(':activityId', activityId);
      } else {
