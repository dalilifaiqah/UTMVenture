    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          ...
          <form id="reservation-form" class="borderadd" name="gs" method="POST" role="search" action="{{url('event')}}" enctype="multipart/form-data">
            @csrf
            <div class="row">
              <div class="col-lg-12">
              ...
              <div class="col-lg-12">
                  <fieldset>
                      ...
                      <input type="text" name="title" id="title" class="Name" placeholder="Ex. Color Run" autocomplete="on" required>
                  </fieldset>
              </div>
              <div class="col-lg-3">
                <fieldset>
                    <label for="actdate" class="form-label">Date of Event</label>
                    <input type="date" name="actdate" id="actdate" class="date" required>
                </fieldset>
              </div>
              <div class="col-lg-6">
                <fieldset>
                    <label for="location" class="form-label">Location</label>
                    <input type="text" name="location" id="location" class="Name" placeholder="Ex. Masjid Sultan Ismail" autocomplete="on" required>
                </fieldset>
              </div>
              <div class="col-lg-3">
                  <fieldset>
                      <label for="type" class="form-label">Type of Request</label>
                      <select name="type" class="form-select" aria-label="Default select example" id="type" onChange="handleTypeChange(this)">
              ...
              <div class="col-lg-12">
                <fieldset>
                    ...
                    <textarea name="description" id="description" class="Name" placeholder="All details about your activity" autocomplete="on" required></textarea>
              ...
              <div class="col-lg-5">
                <fieldset>
                    ...
                    <input type="text" name="link" id="link" class="Name" placeholder="Ex. https://forms.gle/gformcode" autocomplete="on" >
                </fieldset>
              </div>
              <div class="col-lg-4">
                <fieldset>
              ...
              <div class="col-lg-12">                        
                  <fieldset>
                      <button type="submit" value="Save" class="main-button">Make Your Registration Now</button>
                  </fieldset>
              </div>
            </div>
          </form>
