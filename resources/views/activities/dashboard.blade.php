...
<body>
        ...
        <div class="row" style="margin: 5px;">
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <!-- ***** Menu Start ***** -->
                    <ul class="nav">
                        <li><a href="useractivity.html" class="active">Activities/Events</a></li>
                        <li><a href="visitorguidance.html">Visitor Guidance</a></li>
                        <li><div class="dropdown">
                          <button class="dropbtn">Siti Khadijah</button>
  ...
  <div class="page-heading">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
            <h4>Advertising Activities and Events in UTM</h4>
            <h2>Activities & Events Dashboard</h2>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="col-lg-12 " >
          <div class="shadow-2-strong" id="admindashboard">
            <div class="card-body text-center">
                <h4 class="pd-5">User Advertise Request</h4>
                    ...
                    <table class="table">
                        ...
                        @foreach($approvedRequests as $activity)
                            <tr>
                                ...
                                <td>{{$activity->duedate}}</td>
                                <td class="text-center">
                                    <form method="post" action="{{ route('destroy',$activity->id) }}">
                                        
                                        <button type="button" class="btn btn-secondary btn-sm px-3  mg-3" onclick="redirectTo()">
                                        ...
                                        <button type="button" class="btn btn-danger btn-sm px-3  mg-3">
...
<script>
  ...
  function redirectTo() {
      ...
      var targetUrl = "{{ route('show',$activity->id) }}";
